      ...
      <div class="t-left">
        <div class="numboxs">
          <div class="num">
            ...
            <div class="num-value">321</div>
          </div>
          <div class="num">
            <div class="num-name">接警数</div>
            <div class="num-value">42</div>
          </div>
          <div class="num">
            <div class="num-name">派车数</div>
            <div class="num-value">322</div>
          </div>
          <div class="num">
            <div class="num-name">已完成</div>
            <div class="num-value">4122</div>
          </div>
        </div>
        <!-- 左侧两个柱状图 -->
        <div class="left-bar">
      ...
      <div class="t-right">
        <div class="t-right-form">
          <div class="onduty">
            ...
            <div class="tab-main">
              <div class="tab-line">
                <div class="tab-line-status"><span>可以滚动</span></div>
              ...
              <div class="tab-line">
                <div class="tab-line-status"><span>收到指令</span></div>
                <div class="tab-line-name">川A56789</div>
                <div class="tab-line-station">宜春中心医院分站</div>
              </div>
              <div class="tab-line">
...
export default {
  ...
  mounted() {
    ...
    //  饼图
    let pie = E.init(document.getElementById('pie'))
    let pieopt = {
      title: {
        text: '>>任务类型<<',
        textStyle: {
    ...
    let ycmap = E.init(document.getElementById('YCmap'))
